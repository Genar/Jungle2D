...
#if DEBUG
    NSLog(@"<%p %@: %s line:%d>  Allocating font texture, dimensions %dx%d", self, [[NSString stringWithUTF8String:__FILE__] lastPathComponent], __PRETTY_FUNCTION__, __LINE__, width, height);
#endif
