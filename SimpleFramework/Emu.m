...
- (void) flockAgainst:(Emu**) others count:(int)count
{
	...
	CGPoint avg_pos = CGPointMake(0,0);
    CGPoint avg_vel=CGPointMake(0,0);
	...
	if ( (nearest_dist < emuradius * emuradius) && (nearest_emu != nil) )
    {
...
- (void) update:(CGFloat) time
{
	...
	float dx = -worldSpeed.x;
    float dy = -worldSpeed.y;
